...
<html>
  ...
  <body>
    <div class="container">
      <h2>Editar Usuários</h2><br  />
        <form method="post" action="{{action('UsuarioController@editarUsuario', $id)}}">
        @csrf
        ...
        <div class="row">
          <div class="col-md-4"></div>
            <div class="form-group col-md-4">
              ...
              <input type="date" class="form-control" name="date" value="{{$user->data_nascimento}}">
            </div>
          </div>
        <div class="row">
          <div class="col-md-4"></div>
